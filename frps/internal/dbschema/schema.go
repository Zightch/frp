...
CREATE TABLE IF NOT EXISTS certificate_asset_usages (
	...
	updated_at TEXT NOT NULL
			...
			`CREATE UNIQUE INDEX IF NOT EXISTS uk_certificate_asset_usages_usage_target ON certificate_asset_usages (target_type, target_id, usage_type, asset_id)`,
		...
		tables: []tableSpec{
			...
			},
			{
				...
				columns: []columnSpec{
					...
					{name: "listen_tls_mode", columnType: "text", nullable: false},
					{name: "listen_tls_load_system_ca", columnType: "integer", nullable: false},
					{name: "backend_tls_mode", columnType: "text", nullable: false},
					{name: "backend_tls_server_name", columnType: "text", nullable: false},
					{name: "backend_tls_load_system_ca", columnType: "integer", nullable: false},
					{name: "backend_tls_insecure_skip_verify", columnType: "integer", nullable: false},
					{name: "enabled", columnType: "integer", nullable: false},
					{name: "created_at", columnType: "text", nullable: false},
					{name: "updated_at", columnType: "text", nullable: false},
				},
			...
			},
			{
				...
				columns: []columnSpec{
					{name: "id", columnType: "integer", nullable: false, primaryKey: true},
					{name: "target_type", columnType: "text", nullable: false},
				...
				uniqueIndexes: [][]string{
					{"target_type", "target_id", "usage_type", "asset_id"},
				},
			},
		},
	},
...
CREATE TABLE IF NOT EXISTS tunnels (
	...
	listen_tls_mode VARCHAR(16) NOT NULL DEFAULT 'off',
	listen_tls_load_system_ca TINYINT(1) NOT NULL DEFAULT 0,
	backend_tls_mode VARCHAR(16) NOT NULL DEFAULT 'off',
	backend_tls_server_name VARCHAR(255) NOT NULL DEFAULT '',
	backend_tls_load_system_ca TINYINT(1) NOT NULL DEFAULT 0,
	backend_tls_insecure_skip_verify TINYINT(1) NOT NULL DEFAULT 0,
	enabled TINYINT(1) NOT NULL DEFAULT 1,
	created_at DATETIME(6) NOT NULL,
	updated_at DATETIME(6) NOT NULL,
	PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS certificate_asset_usages (
	...
	updated_at DATETIME(6) NOT NULL,
	PRIMARY KEY (id),
	UNIQUE KEY uk_certificate_asset_usages_usage_target (target_type, target_id, usage_type, asset_id),
		...
		tables: []tableSpec{
			...
			},
			{
				...
				columns: []columnSpec{
					...
					{name: "listen_tls_mode", columnType: "varchar(16)", nullable: false},
					{name: "listen_tls_load_system_ca", columnType: "tinyint(1)", nullable: false},
					{name: "backend_tls_mode", columnType: "varchar(16)", nullable: false},
					{name: "backend_tls_server_name", columnType: "varchar(255)", nullable: false},
					{name: "backend_tls_load_system_ca", columnType: "tinyint(1)", nullable: false},
					{name: "backend_tls_insecure_skip_verify", columnType: "tinyint(1)", nullable: false},
					{name: "enabled", columnType: "tinyint(1)", nullable: false},
					{name: "created_at", columnType: "datetime(6)", nullable: false},
					{name: "updated_at", columnType: "datetime(6)", nullable: false},
				},
			...
			},
			{
				...
				columns: []columnSpec{
					{name: "id", columnType: "bigint", nullable: false, primaryKey: true, autoIncrement: true},
					{name: "target_type", columnType: "varchar(32)", nullable: false},
