...
func DesiredTunnelsFromConfig(tunnels []protocol.TunnelEntry) []controlsession.DesiredTunnelRuntime {
	...
	for _, tunnel := range tunnels {
		desired = append(desired, controlsession.DesiredTunnelRuntime{
			...
			ListenTLSMode:                tunnel.ListenTLSMode,
			...
			BackendTLSMode:               tunnel.BackendTLSMode,
			BackendTLSLoadSystemCA:       tunnel.BackendTLSLoadSystemCA,
			BackendTLSInsecureSkipVerify: tunnel.BackendTLSInsecureSkipVerify,
			BackendTLSServerName:         tunnel.BackendTLSServerName,
			BackendTLSCAPEM:              tunnel.BackendTLSCAPEM,
			BackendTLSClientCertPEM:      tunnel.BackendTLSClientCertPEM,
			BackendTLSClientKeyPEM:       tunnel.BackendTLSClientKeyPEM,
